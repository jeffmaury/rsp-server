...
public class ServerModel implements IServerModel {
	...
	public ServerModel(ISecureStorageProvider provider) {
		...
		this.serverTypes = new HashMap<String, IServerType>();
		this.servers = new HashMap<String, IServer>();
		this.serverDelegates = new HashMap<String, IServerDelegate>();
		this.listeners = new ArrayList<IServerModelListener>();
